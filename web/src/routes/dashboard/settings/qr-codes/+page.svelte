...
<div class="p-6 max-w-6xl mx-auto">
	<div class="mb-6">
		<h1 class="text-3xl font-bold text-[#1B3A4B]">QR Codes</h1>
		<p class="text-gray-600 mt-1">Generate printable QR codes for check-ins, connection cards, and more</p>
	</div>
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
		...
		<div class="bg-white rounded-lg shadow-lg p-6">
			<h2 class="text-xl font-bold text-[#1B3A4B] mb-4">Check-In Station</h2>
			...
			{:else}
				<p class="text-gray-500 text-sm mb-4">No check-in stations found. Create one first.</p>
				<a 
		...
		<!-- Connection Card QR -->
		<div class="bg-white rounded-lg shadow-lg p-6">
			<h2 class="text-xl font-bold text-[#1B3A4B] mb-4">Connection Card</h2>
			...
			<p class="text-xs text-gray-500 mt-3">Perfect for pew cards and seat backs</p>
		</div>

		<!-- Giving QR -->
		<div class="bg-white rounded-lg shadow-lg p-6">
			<h2 class="text-xl font-bold text-[#1B3A4B] mb-4">Give</h2>
			...
			<p class="text-xs text-gray-500 mt-3">Display during services or in your bulletin</p>
		</div>

		<!-- Prayer QR -->
		<div class="bg-white rounded-lg shadow-lg p-6">
			<h2 class="text-xl font-bold text-[#1B3A4B] mb-4">Prayer Requests</h2>
			...
			<p class="text-xs text-gray-500 mt-3">Easy way to collect prayer requests</p>
		</div>
	</div>

	<!-- Custom QR Code Builder -->
	<div class="bg-white rounded-lg shadow-lg p-6">
		<h2 class="text-xl font-bold text-[#1B3A4B] mb-4">Custom QR Code</h2>
		<p class="text-gray-600 mb-4">Generate a QR code for any URL</p>
	...
	<div class="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
		<h3 class="font-bold text-blue-900 mb-2">💡 Tips for Using QR Codes</h3>
