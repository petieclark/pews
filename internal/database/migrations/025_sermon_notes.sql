...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_sermon_notes_tenant_id ON sermon_notes(tenant_id);
CREATE INDEX IF NOT EXISTS idx_sermon_notes_date ON sermon_notes(sermon_date DESC);
CREATE INDEX IF NOT EXISTS idx_sermon_notes_series ON sermon_notes(tenant_id, series_name);
CREATE INDEX IF NOT EXISTS idx_sermon_notes_speaker ON sermon_notes(tenant_id, speaker);
CREATE INDEX IF NOT EXISTS idx_sermon_notes_published ON sermon_notes(tenant_id, published);
CREATE INDEX IF NOT EXISTS idx_sermon_notes_service_id ON sermon_notes(service_id);
